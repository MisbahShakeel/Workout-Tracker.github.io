export default class WorkoutTracker {
    ...
    static rowHtml() {
        ...
        <td>
            <button type="button" class="tracker__button tracker_-delete">x</button>
        </td>
    </tr>
    `;
    ...
    updateView() {
        ...
        row.querySelector(".tracker__date").value = data.data;
        ...
        row.querySelector(".tracker_-delete").addEventListener("click", () => {
